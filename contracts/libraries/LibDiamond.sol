...
library LibDiamond {
    ...
    bytes32 constant AutoFarmV2_STORAGE_POSITION = keccak256("diamond.standard.AutoFarmV2.storage");
    bytes32 constant StratX2_STORAGE_POSITION = keccak256("diamond.standard.StratX2.storage");
    ...
    function autoFarmV2Storage() internal pure returns (AutoFarmV2Storage storage a) {
